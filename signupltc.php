...
{
    echo"<center>"; 
        echo "<div class='card text-white bg-danger mb-3' style='max-width: 18rem;'><div class='card-header'>Account can't be created!</div><div class='card-body'><h5 class='card-title'>All inputs are neccessary!</h5><p class='card-text'>All inputs are necessary  to create new account</p><button class='btn-secondary'><a href='index.php'>Go Back</button></div></div>";
        echo "</center>";
}
else{
	...
	{   
		...
		echo"<center>"; 
        echo "<div class='card text-white bg-success mb-3' style='max-width: 18rem;'><div class='card-header'>Account Created!</div><div class='card-body'><h5 class='card-title'>Welcome,".$fname. "</h5><p class='card-text'>Hello welcome to the family of learners </p><button class='btn-success'><a href='index.php'>Go Home!</button></div></div>";
        echo "</center>"; 
	}
}
?>
