...
<div class="dashboard">
    ...
    <center>
        <img src="../img/deafaultuser.jpg" class="adminimage img-responsive"></center>
    <hr>
    <div style="line-height:0px;">
        ...
        <form action="usersuggestion.php" method="post">
        ...
        <form action="chat2.php" method="get">
            <button type="submit" class="links"><span class="glyphicon glyphicon-envelope"></span>Chat with admin
            </button>
        </form>
...
<div class="adminbadges">
    <div class="card">
        ...
        <img src="../img/deafaultuser.jpg" alt="John">
        ...
        <p>
            <button type="submit" id="javascript">Edit Profile Details</button>
        </p>
    </div>
</div>
