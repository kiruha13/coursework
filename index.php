...
<style>
    ...
    .price-table:hover {
        box-shadow: 5px 5px 5px #332f2f, -5px 0px 5px lightgrey;
    }
            ...
            <div class="row">
                <div class="banner-text text-center">
                    ...
                    <div class="intro-para text-center quote">
                        ...
                        <p class="small-text">An easy and organized way to explore the world of coding through the
                            window of our website</p>
    ...
    <div class="container">
        <div class="row">
            <div class="header-section text-center">
                <h2>Features</h2>
                <p>We try to provide our loyal users a rich and soothing experience in their path of learning<br>We do
                    our best ,but suggestions are welcomed</p>
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="detail-info">
                    ...
                    <p class="det-p">Donec et lectus bibendum dolor dictum auctor in ac erat. Vestibulum egestas
                        sollicitudin metus non urna in eros tincidunt convallis id id nisi in interdum.</p>
                </div>
            </div>
            <button class="mybutton" style="float: right;background-color: black;">
                <span style="color:#8d4820;">More..</span>
            </button>
        </div>
    </div>
</section>
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="cta-2-form text-center">
                    <form action="subscribe.php" method="post" id="workshop-newsletter-form">
                        <input id="mail" name="mail" placeholder="Enter Your Email Address" type="email">
    ...
    <div class="container">
        <div class="row">
            <div class="header-section text-center">
                ...
                <p class="workshop">Upcoming workshops specially for you <br> HURRY UP!</p>
                <hr class="bottom-line">
            </div>
            ...
            <div class="col-md-4 col-sm-6">
                ...
                <button class="mybutton" style="float: right;background-color: black;">
                    <span>
                        <a href="courses.php"
                           style='text-decoration:none; background-color: black;color:white;'>More..</a>
                    </span>
                </button>
            </div>
        </div>
...
<section id="pricing" class="section-padding">
    <div class="container">
        <div class="row">
            <div class="header-section text-center">
                <h2>Our Pricing</h2>
                <p class="price-p">Get professional and complete access to our website<br>and let the Learning Begin!
                </p>
                <hr class="bottom-line">
            </div>
        ...
        <div class="row">
            ...
            <form action="contact.php" method="post">
                ...
                <div class="col-xs-12">
                    ...
                    <input type="submit" class="form contact-form-button light-form-button oswald light"
                           value="Send message">
                </div>
            </form>
            <!--          MESSAGE FORM-->
...
<footer id="footer" class="footer">
    <div class="container text-center">
        ...
        ©2023 Learn To Code All rights reserved
        <div class="credits">
            Designed by <a href="https://github.com/kiruha13">Korobkin Kirill</a>
        </div>
    </div>
</footer>
<!--/ Footer-->
