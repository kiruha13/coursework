...
<div class="dashboard">
    ...
    <br>
    <center>
        <img src="../img/admin.jpg" class="adminimage img-responsive"></center>
    <hr>
    <div style="line-height:0px;">
        <form action="adsuggestion.php" method="post">
        ...
        <br>
        <form action="admessage.php" method="post">
        ...
        <br>
        <form action="adpayment.php" method="post">
        ...
        <form action="adrating.php" method="post">
