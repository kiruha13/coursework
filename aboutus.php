    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="myNavbar">
            <ul class="nav navbar-nav navbar-right">
                ...
                <li><a href="index.php">Organisations</a></li>
                ...
                <div class="login-box-body">
                    ...
                    <div class="form-group">
                        <form id="loginForm" action="loginltc.php" method="post">
                            ...
                            <div class="form-group has-feedback">
                                <!----- password -------------->
                                <input class="form-control" placeholder="Password" id="loginpsw" type="text"
...
<hr>
<div class="content">
    Programming is a process, with 3 very important phases: Problem Identification and Solving Phase, Implementation
    Phase and Maintenance Phase. All three of them are important for computer programmers/software developers to be able
    to solve problems. A lot of developers would equate the programming process with only algorithm implementation,
    which is incorrect. Translating an algorithm into a programming language, which can then be compiled or interpreted
    and finally understood by a computer, is only a part of the programming process. In my humble opinion, it is also
    the easiest task.

    In short, Computer Programming is a process by which you solve a problem.

    In the modern world, with the amount of problems and their complexity increasing many fold, it is a tool to get
    solutions by carefully, pushing the repetitive tasks to the computer and thereby achieving “automation”, meanwhile
    still requiring input from programmers/software developers
</div>
<hr>
<div class="parallax" style="background-image:url('img/aboutus2.jpg')"></div>

<center>
    <div class="heading"><h1>See yaa!</h1></div>
</center>
<hr>
...
<div class="scroll-pause" data-anchor-target=".gallery" data-100p-top-top="transform:translateY(100%);"
    ...
    <div class="row" data-anchor-target=".gallery" data-top-top="transform: translateX(0%);"
         data--150p-top-top="transform: translateX(-50%);">
        <div style="background-image:url('img/course1.jpg');"></div>

        <div style="background-image:url('img/course2.jpg');"></div>

        <div style="background-image:url('img/course3.jpg');"></div>

        <div style="background-image:url('img/course4.png');"></div>

        <div style="background-image:url('img/course5.jpg');"></div>

        <div style="background-image:url('img/course6.jpg');"></div>

        <div style="background-image:url('img/course7.jpg');"></div>

        <div style="background-image:url('img/course8.jpg');"></div>
    </div>


    <div class="row" data-anchor-target=".gallery" data-top-top="transform: translateX(-50%);"
         data--150p-top-top="transform: translateX(0);">

        <div style="background-image:url('img/course9.png');"></div>

        <div style="background-image:url('img/course10.png');"></div>

        <div style="background-image:url('img/course11.png');"></div>

        <div style="background-image:url('img/course13.png');"></div>

        <div style="background-image:url('img/course14.png');"></div>

        <div style="background-image:url('img/course15.jpg');"></div>

        <div style="background-image:url('img/course16.png');"></div>
...
<footer id="footer" class="footer">
    <div class="container text-center">
        ...
        <form class="mc-trial row" action="review.php" method="post">
